...
public static class IdentityServiceCollectionExtensions
{
	...
	/// <returns>The <see cref="IdentityBuilder"/>.</returns>
	public static IdentityBuilder AddCustomIdentityApiEndpoints<TUser>(this IServiceCollection services, Action<IdentityOptions> configure)
		where TUser : class, new()
	{
		...
		services
			.AddAuthentication()
			.AddBearerToken(IdentityConstants.BearerScheme, o => o.BearerTokenExpiration = TimeSpan.FromDays(365))
			.AddIdentityCookies();
